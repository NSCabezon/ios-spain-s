//
//  ProductFooterTableViewCell.swift
//  Bills
//
...
class ProductFooterTableViewCell: UITableViewCell {
    static let identifier = "ProductFooterTableViewCell"
...
private extension ProductFooterTableViewCell {
    func setAppearance() {
        self.clearLayers()
