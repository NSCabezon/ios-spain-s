...
public struct CollectionSection<Element: Hashable>: SectionProtocol, Identifiable {
...
extension CollectionSection: Equatable {
    public static func == (lhs: CollectionSection<Element>, rhs: CollectionSection<Element>) -> Bool {
...
extension CollectionSection: RandomAccessCollection {
