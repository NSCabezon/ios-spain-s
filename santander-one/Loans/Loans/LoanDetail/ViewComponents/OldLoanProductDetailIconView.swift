...
final class OldLoanProductDetailIconView: XibView {
    
    @IBOutlet private weak var titleLabel: UILabel!
    @IBOutlet private weak var valueLabel: UILabel!
    @IBOutlet private weak var shareImageView: UIImageView!
    
    weak var delegate: OldLoanProductDetailIconViewDelegate?
    ...
    func setupViewModel(title: String, value: String) {
        self.titleLabel?.text = title
        self.valueLabel.text = value
    }
    
    func setupViewModel(title: String,
                        value: String,
...
private extension OldLoanProductDetailIconView {
    func setupView() {
