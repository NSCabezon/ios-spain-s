...
protocol OldLoanSearchViewProtocol: AnyObject {
    ...
    func hideFiltersViewsIfNeeded(_ filtersConfig: OldLoanSearchModifier)
}

final class OldLoanSearchViewController: UIViewController {
    var presenter: OldLoanSearchPresenterProtocol
    ...
    init(nibName: String?, bundle: Bundle?, presenter: OldLoanSearchPresenterProtocol) {
...
private extension OldLoanSearchViewController {
...
extension OldLoanSearchViewController: OldLoanSearchViewProtocol {
    func hideFiltersViewsIfNeeded(_ filtersConfig: OldLoanSearchModifier) {
        ...
        self.conceptSeparatorView.isHidden = !filtersConfig.isEnabledConceptFilter
        self.segmentedControlView.isHidden = !filtersConfig.isEnabledConceptFilter
    }
...
extension OldLoanSearchViewController: OldDialogViewPresentationCapable { }

extension OldLoanSearchViewController: OperativeFilterViewDelegate, AmountRangeFilterViewDelegate, DateFilterViewDelegate {
