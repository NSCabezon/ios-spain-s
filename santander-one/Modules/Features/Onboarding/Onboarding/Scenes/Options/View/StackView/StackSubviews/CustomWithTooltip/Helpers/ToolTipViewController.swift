...
class ToolTipViewController: UIViewController {
    ...
    private let titleFont = UIFont.santander(family: .text, type: .regular, size: 15)
    private let descriptionFont = UIFont.santander(family: .text, type: .light, size: 14)
    ...
    override func viewDidLoad() {
        ...
        separatorView.backgroundColor = .santanderRed
    }
    ...
    func setPopoverDescriptionLocalized(text: LocalizedStylableText) {
        ...
        descriptionLabel.configureText(withLocalizedString: text)
