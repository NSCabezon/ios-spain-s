...
class PushNotificationsOptionOnboardingViewModel: OnboardingStackItem<PushNotificationsOptionOnboardingView> {
    ...
    init(stringLoader: StringLoader, userName: String, switchState: Bool, title: String?, change: ((PushNotificationsOptionOnboardingViewModel) -> Void)?, insets: OnboardingStackViewInsets = OnboardingStackViewInsets(left: 0, right: 0, top: 0, bottom: 24)) {
