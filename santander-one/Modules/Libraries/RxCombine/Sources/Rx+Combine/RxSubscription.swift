...
class RxSubscription<Upstream: ObservableConvertibleType, Downstream: Subscriber>: OpenCombine.Subscription where Downstream.Input == Upstream.Element, Downstream.Failure == Swift.Error {
...
class RxInfallibleSubscription<Upstream: ObservableConvertibleType, Downstream: Subscriber>: OpenCombine.Subscription where Downstream.Input == Upstream.Element, Downstream.Failure == Never {
    private var disposable: Disposable?
    private let buffer: DemandBuffer<Downstream>
