//
//  UserPreferencesRepositoryMock.swift
//  ExampleApp
//
//  Created by Jose Ignacio de Juan Díaz on 3/12/21.
//
...
public final class UserPreferencesRepositoryMock: UserPreferencesRepository {
    public var spyUpdateUserPreferences: UpdateUserPreferencesRepresentable?
    
    public init() {}
    
    public func getUserPreferences(userId: String) -> AnyPublisher<UserPreferencesRepresentable, Error> {
        return Just(UserPreferencesMock(isPrivateMenuCoachManagerShown: false))
            .setFailureType(to: Error.self)
            .eraseToAnyPublisher()
    }
    
    public func updateUserPreferences(update: UpdateUserPreferencesRepresentable) {
        spyUpdateUserPreferences = update
    }
}

private extension UserPreferencesRepositoryMock {
    struct UserPreferencesMock: UserPreferencesRepresentable {
