//
//  GetPersonalAreaHomeFieldsUseCaseMock.swift
//  PersonalArea
//
...
public final class GetPersonalAreaHomeFieldsUseCaseMock: GetPersonalAreaHomeFieldsUseCase {
    
    public init() {}
    
    public func fetchPersonalAreaHomeFields(_ config: PersonalAreaHomeRepresentable) -> AnyPublisher<[PersonalAreaCellInfoRepresentable], Never> {
        Just(fieldsWith(config: config)).eraseToAnyPublisher()
    }
}

private extension GetPersonalAreaHomeFieldsUseCaseMock {
