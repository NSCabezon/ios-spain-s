...
struct CertificateRequest {
    ...
    init(forPublicKey key:SecKey, subjectCommonName:String, subjectOrganizationName:String, countryName:String, keyUsage:KeyUsage,
                      validFrom:Date? = nil, validTo:Date? = nil, serialNumber:UInt64? = nil) {
        self.publicKey = key
        self.countryName = countryName
        self.subjectCommonName = subjectCommonName
        self.subjectOrganizationName = subjectOrganizationName
...
extension CertificateRequest {
    func info(usingSubjectAsIssuer: Bool = false) -> NSArray? {
        ...
        subject.organizationName = subjectOrganizationName
