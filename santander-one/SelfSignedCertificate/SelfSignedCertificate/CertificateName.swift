...
class CertificateName : NSObject {
    ...
    var countryName: String {
        get { return string(for: OID.countryName) }
        set { setString(newValue, forOid:OID.countryName) }
    }
    ...
    var organizationName: String {
        get { return string(for: OID.organizationName) }
        set { setString(newValue, forOid:OID.organizationName) }
    }
