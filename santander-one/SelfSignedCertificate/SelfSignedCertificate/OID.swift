...
extension OID {
    ...
    @nonobjc static let rsaWithSHA256AlgorithmID = OID(components:[1, 2, 840, 113549, 1, 1, 11])
    @nonobjc static let rsaWithMD5AlgorithmID = OID(components:[1, 2, 840, 113549, 1, 1, 4 ])
    @nonobjc static let rsaWithMD2AlgorithmID = OID(components:[1, 2, 840, 113549, 1, 1, 2])

    /** SUBJECT **/
    @nonobjc static let commonName = OID(components:[2, 5, 4, 3])
    @nonobjc static let countryName = OID(components:[2, 5, 4, 6])
    @nonobjc static let organizationName = OID(components:[2, 5, 4, 10])
    @nonobjc static let givenNameOID = OID(components:[2, 5, 4, 42])
    @nonobjc static let surnameOID = OID(components:[2, 5, 4, 4])
    @nonobjc static let descriptionOID = OID(components:[2, 5, 4, 13])
