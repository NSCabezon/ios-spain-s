//
//  OneShortcutButtonHorizontal.swift
//  UIOneComponents
//
...
// MARK: - OneShortcutButtonHorizontal

public final class OneShortcutButtonHorizontal: XibView {
...
public extension OneShortcutButtonHorizontal {
...
private extension OneShortcutButtonHorizontal {
    func setupView() {
    ...
    func setupTitle(_ title: String?) {
        ...
        titleLabel.text = localized(title).replace("\n", " ")
