...
class RadioSubtitleTableViewCell: GroupableTableViewCell, RadioComponentProtocol {
    ...
    override func awakeFromNib() {
        ...
        subtitleLabel.applyStyle(LabelStylist(textColor: .sanGreyDark, font: .latoBold(size: 24)))
    ...
    override func prepareForReuse() {
        ...
        titleLabel.applyStyle(LabelStylist(textColor: .sanGreyDark, font: .latoSemibold(size: 16)))
        subtitleLabel.applyStyle(LabelStylist(textColor: .sanGreyDark, font: .latoBold(size: 24)))
        arrowImageView.image = Assets.image(named: "icnArrowRightSmall")
        updateMarked()
    }
    ...
    func subtitle(isVisible: Bool) {
        subtitleLabel.isHidden = !isVisible
        arrowImageView.isHidden = !isVisible
    }
    ...
    private func updateMarked() {
        insideHeghtConstraint?.constant = 0
    ...
    func setAccessibilityIdentifiers(identifier: String) {
        ...
        buttonInfo.accessibilityIdentifier = identifier + "_buttonInfo"
        arrowImageView.isAccessibilityElement = true
        viewRed.isAccessibilityElement = true
        viewGray.isAccessibilityElement = true
        setAccessibility {
            self.arrowImageView.isAccessibilityElement = false
            self.viewRed.isAccessibilityElement = false
            self.viewGray.isAccessibilityElement = false
        }
        arrowImageView.accessibilityIdentifier = identifier + "_arrowImage"
        viewRed.accessibilityIdentifier = identifier + "_viewRed"
        viewGray.accessibilityIdentifier = identifier + "_viewGray"
    }
}

extension RadioSubtitleTableViewCell: AccessibilityCapable { }
