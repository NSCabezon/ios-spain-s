...
class RadioButtonAndDateCell: RadioButtonCell {
    
    // MARK: - Outlets
    
    @IBOutlet private weak var dateTextField: NotCopyPasteTextField! {
        didSet {
    ...
    private lazy var calendarView: UIView = {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(RadioButtonAndDateCell.didClickCalendarView))
...
extension RadioButtonAndDateCell: DatePickerCell {
