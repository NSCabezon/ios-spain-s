...
protocol FundTransferConfirmationPresenterProtocol: Presenter {
    func confirmButtonTouched()
}

class FundTransferConfirmationViewController: BaseViewController<FundTransferConfirmationPresenterProtocol> {
    ...
    override func prepareView() {
        ...
        tableView.registerCells(["GenericConfirmationTableViewCell", "ConfirmationItemsListHeader", "ConfirmationItemViewCell", "FundTransferConfirmationViewCell"])
