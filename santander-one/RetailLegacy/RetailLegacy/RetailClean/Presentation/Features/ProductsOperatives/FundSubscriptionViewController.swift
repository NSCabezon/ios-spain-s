...
protocol FundSubscriptionPresenterProtocol: Presenter {
    func selected(index: IndexPath)
    func onContinueButtonClicked()
}

class FundSubscriptionViewController: BaseViewController<FundSubscriptionPresenterProtocol> {
...
extension FundSubscriptionViewController: TableDataSourceDelegate {
