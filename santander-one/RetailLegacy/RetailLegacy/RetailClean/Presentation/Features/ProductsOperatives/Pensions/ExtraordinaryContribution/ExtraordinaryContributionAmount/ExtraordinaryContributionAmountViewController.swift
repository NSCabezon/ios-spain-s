...
protocol ExtraordinaryContributionAmountPresenterProtocol: Presenter {
    func confirmButtonTouched()
}

class ExtraordinaryContributionAmountViewController: BaseViewController<ExtraordinaryContributionAmountPresenterProtocol> {
