...
protocol PeriodicalContributionConfirmationPresenterProtocol: Presenter {
    func confirmButtonTouched()
}

class PeriodicalContributionConfirmationViewController: BaseViewController<PeriodicalContributionConfirmationPresenterProtocol> {
