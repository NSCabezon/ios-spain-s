...
protocol PayLaterCardConfirmationPresenterProtocol: Presenter {
    func confirmButtonTouched()
}

class PayLaterCardConfirmationViewController: BaseViewController<PayLaterCardConfirmationPresenterProtocol> {
    ...
    override func prepareView() {
        ...
        tableView.registerCells(["CardConfirmationTableViewCell", "ConfirmationItemViewCell", "OperativeLabelTableViewCell", "OperativeSeparatorTableViewCell", "ConfirmationItemsListHeader"])
    ...
    private func setAccessibilityIdentifiers() {
        confirmButton.accessibilityIdentifier = AccessibilityCardPayLater.confirmButtonConfinrm
        titleIdentifier = AccessibilityCardPayLater.confirmTitle
    }
}
