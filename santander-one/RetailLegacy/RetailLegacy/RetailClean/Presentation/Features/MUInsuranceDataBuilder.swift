...
struct MUInsuranceDataBuilder {
    ...
    func getGeneralData(_ insuranceData: InsuranceData, insuranceProtection: InsuranceProtection) -> [DateProvider] {
        ...
        //        }
        //        if let numberInsuredAddresses = insuranceData.numberInsuredAddresses {
        //            data.append(InsuranceGeneralDataViewModel(isFirst: false, isLast: false, isCopiable: false, infoTitle: dependencies.stringLoader.getString("insurance_label_numberAddresses"), info: numberInsuredAddresses.camelCasedString, privateComponent: dependencies, shareDelegate: shareDelegate))
        //        }
