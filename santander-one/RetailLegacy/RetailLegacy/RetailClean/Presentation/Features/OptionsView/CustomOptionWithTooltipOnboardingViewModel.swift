//
//  CustomOptionWithTooltipOnboardingViewModel.swift
//  RetailLegacy
//
...
final class CustomOptionWithTooltipOnboardingViewModel: StackItem<CustomOptionWithTooltipOnboardingView> {
...
private extension CustomOptionWithTooltipOnboardingViewModel {
    func addCells(_ viewModel: [CustomOptionWithTooltipOnboardingCellViewModel]) -> [CustomOptionWithTooltipOnboardingCellView] {
        ...
        for cellViewModel in viewModel {
            ...
            cellView.switchValueDidChange = { [weak self] switchValue in
