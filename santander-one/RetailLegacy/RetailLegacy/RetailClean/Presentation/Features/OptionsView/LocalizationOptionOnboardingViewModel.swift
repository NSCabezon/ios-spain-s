...
class LocalizationOptionOnboardingViewModel: StackItem<LocalizationOptionOnboardingView> {
    ...
    init(stringLoader: StringLoader, switchState: Bool, title: String?, change: ((LocalizationOptionOnboardingViewModel) -> Void)?, insets: Insets = Insets(left: 0, right: 0, top: 0, bottom: 24)) {
