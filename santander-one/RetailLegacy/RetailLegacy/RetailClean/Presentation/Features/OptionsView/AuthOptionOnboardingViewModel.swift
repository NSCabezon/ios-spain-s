...
class AuthOptionOnboardingViewModel: StackItem<AuthOptionOnboardingView> {
    ...
    init(stringLoader: StringLoader, type: BiometryTypeEntity, switchState: Bool, change: ((AuthOptionOnboardingViewModel) -> Void)?, insets: Insets = Insets(left: 0, right: 0, top: 0, bottom: 24)) {
