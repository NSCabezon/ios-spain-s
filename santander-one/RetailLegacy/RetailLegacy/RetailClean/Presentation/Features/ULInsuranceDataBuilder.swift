...
struct ULInsuranceDataBuilder {
    ...
    func getDataForULInsurance(_ insuranceData: InsuranceData, insuranceSaving: InsuranceSaving) -> [DateProvider] {
        ...
        if let marketValueAmount = insuranceData.marketValueAmount {
            data.append(InsuranceGeneralDataViewModel(isFirst: false, isLast: false, isCopiable: false, infoTitle: dependencies.stringLoader.getString("insurances_label_marketAmount"), info: marketValueAmount.getFormattedAmountUIWith1M(), privateComponent: dependencies, shareDelegate: shareDelegate))
        }
    ...
    func getParticipantsDataForULInsurance(_ participants: InsuranceParticipantList) -> [DateProvider] {
        var result = [DateProvider]()
    ...
    func getBeneficiariesDataForULInsurance(_ beneficiaries: InsuranceBeneficiaryList) -> [DateProvider] {
        var result = [DateProvider]()
