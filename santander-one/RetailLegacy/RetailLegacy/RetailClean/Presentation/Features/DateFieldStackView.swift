...
class DateFieldStackView: StackItemView, UITextFieldDelegate {
    var date: String? {
        get {
    ...
    private lazy var calendarView: UIView = {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(didClickCalendarView))
...
extension DateFieldStackView: DatePickerCell {
