...
class ImpositionTransactionViewCell: BaseViewCell, ProductTransactionCell {
    ...
    override func awakeFromNib() {
        ...
        amountLabel.applyStyle(LabelStylist(textColor: .sanGreyDark, font: .latoBold(size: 22.0), textAlignment: .right))
