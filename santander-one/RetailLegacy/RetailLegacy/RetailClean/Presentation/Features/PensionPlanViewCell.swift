...
class PensionPlanViewCell: BaseViewCell, ProductTransactionCell {
    ...
    override func awakeFromNib() {
        ...
        transactionAmountLabel.applyStyle(LabelStylist(textColor: .sanGreyDark, font: .latoBold(size: 24.0), textAlignment: .right))
