...
struct PublicFilesEnvironments {
    ...
    static let xmlEndpointCiberDev: String = "http://serverftp.ciber-es.com:82/movilidad/files_dev/"
    static let xmlEndpointRC: String = "http://serverftp.ciber-es.com:82/movilidad/files_rc/"
    static let xmlEndpointCiberQA: String = "http://serverftp.ciber-es.com:82/movilidad/files_qa/"
    static let xmlEndpointCiberIsban: String = "http://serverftp.ciber-es.com:82/movilidad/files/"
    static let xmlEndpointCiberNegocio: String = "http://serverftp.ciber-es.com:82/movilidad/files_negocio/"
    static let xmlEndpointCiberElab: String = "http://serverftp.ciber-es.com:82/movilidad/files_elab/"
