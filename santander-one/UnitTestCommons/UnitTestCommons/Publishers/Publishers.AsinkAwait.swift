...
public extension OpenCombine.Publisher {
    ...
    func sinkAwaitError(timeout: TimeInterval = 1, file: StaticString = #file, line: UInt = #line,
                   beforeWait: (() -> Void)? = nil) throws -> Failure {
...
private extension OpenCombine.Publisher {
