...
final class BizumHomeOperationCollectionViewCell: UICollectionViewCell {
    ...
    func set(_ viewModel: BizumHomeOperationViewModel) {
...
private extension BizumHomeOperationCollectionViewCell {    
    func configureView() {
