...
protocol BizumMultimediaGalleryDelegate: class {
    func cameraWasTapped()
    func openImageDetail(_ image: Data)
}

protocol BizumAmountMultimediaViewProtocol {
...
extension BizumAmountViewController: BizumMultimediaGalleryDelegate {
    func cameraWasTapped() {
...
extension BizumAmountViewController {
    func showMultimediaView(_ model: BizumMultimediaViewModel) {
...
extension BizumAmountViewController: SystemSettingsNavigatable {}
