import Foundation
public class ValidateLoadPrepaidCardRequest: BSANSoapRequest <ValidateLoadPrepaidCardRequestParams, ValidateLoadPrepaidCardHandler, ValidateLoadPrepaidCardResponse, ValidateLoadPrepaidCardParser> {
    
    public static let serviceName = "validaCargaTarPrepago_LA"
    
    public override var serviceName: String {
        return ValidateLoadPrepaidCardRequest.serviceName
    }
