import Foundation
public class ConfirmOTPUnloadPrepaidCardRequest: BSANSoapRequest <ConfirmOTPUnloadPrepaidCardRequestParams, ConfirmOTPUnloadPrepaidCardHandler, BSANSoapResponse, ConfirmOTPUnloadPrepaidCardParser> {
    
    public static let serviceName = "confDescargaTarPrepago_LA"
    
    public override var serviceName: String {
        return ConfirmOTPUnloadPrepaidCardRequest.serviceName
    }
    ...
    private func getPreliqDataXML(preliqDataDTO: PreliqDataDTO?) -> String{
        ...
        return
            "               <conceptoLiq>\(preliqDataDTO.liqConcept ?? "")</conceptoLiq>\n" +
