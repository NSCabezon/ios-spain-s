...
public class ValidateCreateSepaPayeeOTPRequest: BSANSoapRequest<ValidateCreateSepaPayeeOTPRequestParams, ValidateCreateSepaPayeeOTPHandler, ValidateCreateSepaPayeeOTPResponse, ValidateCreateSepaPayeeOTPParser> {
    
    static public var serviceName = "firmaAltaPayeeSepaLa"
    
    public override var serviceName: String {
        return ValidateCreateSepaPayeeOTPRequest.serviceName
    }
