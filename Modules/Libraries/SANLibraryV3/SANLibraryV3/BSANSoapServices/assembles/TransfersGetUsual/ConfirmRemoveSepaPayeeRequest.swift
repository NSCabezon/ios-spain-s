...
public class ConfirmRemoveSepaPayeeRequest: BSANSoapRequest<ConfirmRemoveSepaPayeeRequestParams, BSANSoapEmptyParser.Handler, BSANSoapEmptyResponse, BSANSoapEmptyParser> {
    
    static public let serviceName = "confirmaBajaPayeeLa"
    
    public override var serviceName: String {
        return ConfirmRemoveSepaPayeeRequest.serviceName
    }
