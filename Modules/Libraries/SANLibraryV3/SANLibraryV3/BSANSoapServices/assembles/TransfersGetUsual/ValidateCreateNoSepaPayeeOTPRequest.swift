...
public class ValidateCreateNoSepaPayeeOTPRequest: BSANSoapRequest<ValidateCreateNoSepaPayeeOTPRequestParams, ValidateCreateNoSepaPayeeOTPHandler, ValidateCreateNoSepaPayeeOTPResponse, ValidateCreateNoSepaPayeeOTPParser> {
    
    static public var serviceName = "firmaAltaPayeeNoSepaLa"
    
    public override var serviceName: String {
        return ValidateCreateNoSepaPayeeOTPRequest.serviceName
    }
