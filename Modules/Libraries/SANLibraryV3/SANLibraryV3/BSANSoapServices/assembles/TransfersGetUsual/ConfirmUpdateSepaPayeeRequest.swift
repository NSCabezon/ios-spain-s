...
public class ConfirmUpdateSepaPayeeRequest: BSANSoapRequest<ConfirmUpdateSepaPayeeRequestParams, BSANSoapEmptyParser.Handler, BSANSoapEmptyResponse, BSANSoapEmptyParser> {
    
    static public var serviceName = "confirmaModifPayeeSepaLa"
    
    public override var serviceName: String {
        return ConfirmUpdateSepaPayeeRequest.serviceName
    }
