...
public class ConfirmUpdateNoSepaPayeeRequest: BSANSoapRequest<ConfirmUpdateNoSepaPayeeRequestParams, BSANSoapEmptyParser.Handler, BSANSoapEmptyResponse, BSANSoapEmptyParser> {
    
    static public var serviceName = "confirmaModifPayeeNoSepaLa"
    
    public override var serviceName: String {
        return ConfirmUpdateNoSepaPayeeRequest.serviceName
    }
