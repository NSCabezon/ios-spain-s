import Foundation
public class ConfirmSellStockTypeOrderRequest: BSANSoapRequest <ConfirmSellStockTypeOrderRequestParams, ConfirmSellStockTypeOrderHandler, ConfirmSellStockTypeOrderResponse, ConfirmSellStockTypeOrderParser> {
    
    public static let serviceName = "confirmaVentaValoresTipoOrden_LIP"
    
    public override var serviceName: String {
        return ConfirmSellStockTypeOrderRequest.serviceName
    }
