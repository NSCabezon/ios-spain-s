import Foundation
public class ConfirmBuyStockLimitedRequest: BSANSoapRequest <ConfirmBuyStockLimitedRequestParams, ConfirmBuyStockLimitedHandler, ConfirmBuyStockLimitedResponse, ConfirmBuyStockLimitedParser> {
    
    public static let serviceName = "confirmaCompraValoresLimitada_LIP"
    
    public override var serviceName: String {
        return ConfirmBuyStockLimitedRequest.serviceName
    }
