...
public class ValidateBuyStockLimitedParser : BSANParser <ValidateBuyStockLimitedResponse, ValidateBuyStockLimitedHandler> {
    override func setResponseData(){
        response.stockDataBuyDTO = handler.stockDataBuyDTO
    }
}

public class ValidateBuyStockLimitedHandler: BSANHandler {
