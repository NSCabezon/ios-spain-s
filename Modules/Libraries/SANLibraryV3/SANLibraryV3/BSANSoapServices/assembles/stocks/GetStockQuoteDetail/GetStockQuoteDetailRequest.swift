import Foundation
public class GetStockQuoteDetailRequest: BSANSoapRequest <GetStockQuoteDetailRequestParams, GetStockQuoteDetailHandler, GetStockQuoteDetailResponse, GetStockQuoteDetailParser> {
    
    public static let serviceName = "detalleCotizacion_LIP"
    
    public override var serviceName: String {
        return GetStockQuoteDetailRequest.serviceName
    }
