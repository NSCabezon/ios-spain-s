import Foundation
public class ValidateBuyStockTypeOrderRequest: BSANSoapRequest <ValidateBuyStockTypeOrderRequestParams, ValidateBuyStockTypeOrderHandler, ValidateBuyStockTypeOrderResponse, ValidateBuyStockTypeOrderParser> {
    
    public static let serviceName = "validaCompraValoresTipoOrden_LIP"
    
    public override var serviceName: String {
        return ValidateBuyStockTypeOrderRequest.serviceName
    }
