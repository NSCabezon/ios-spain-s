import Foundation
public class ValidateSellStockLimitedRequest: BSANSoapRequest <ValidateSellStockLimitedRequestParams, ValidateSellStockLimitedHandler, ValidateSellStockLimitedResponse, ValidateSellStockLimitedParser> {
    
    public static let serviceName = "validaVentaValoresLimitada_LIP"
    
    public override var serviceName: String {
        return ValidateSellStockLimitedRequest.serviceName
    }
