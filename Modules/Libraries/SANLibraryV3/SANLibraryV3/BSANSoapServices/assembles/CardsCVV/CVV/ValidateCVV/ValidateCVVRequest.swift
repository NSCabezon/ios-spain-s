...
public class ValidateCVVRequest: BSANSoapRequest <ValidateCVVRequestParams, ValidateCVVHandler, ValidateCVVResponse, ValidateCVVParser> {
    
    public static let serviceName = "validarConsultaDeCVV2_LA"
    
    public override var serviceName: String {
        return ValidateCVVRequest.serviceName
    }
