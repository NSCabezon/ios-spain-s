import Foundation
 class ConfirmSanKeyTransferRequest: BSANSoapRequest <ConfirmSanKeyTransferRequestParams, ConfirmGenericTransferHandler, ConfirmGenericTransferResponse, ConfirmGenericTransferParser> {
    
    public static let serviceName = "sanKeyConfirmarNacionalSEPA_LA"
    
    public override var serviceName: String {
        return ConfirmSanKeyTransferRequest.serviceName
    }
    ...
    override var message: String {
        let returnString = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
            ...
            "                   <tokenPasos>\(params.tokenSteps)</tokenPasos>" +
