...
public class ModifyPeriodicTransferRequest: BSANSoapRequest<ModifyPeriodicTransferRequestParams, ModifyPeriodicTransferHandler, ModifyPeriodicTransferResponse, ModifyPeriodicTransferParser> {
    
    private static let SERVICE_NAME = "modificarPeriodicaDetalleLa"
    ...
    public override var serviceName: String {
        return ModifyPeriodicTransferRequest.SERVICE_NAME
    }
...
public struct ModifyPeriodicTransferRequestParams {
