...
public class ValidateScheduledTransferOTPRequest: BSANSoapRequest<ValidateScheduledTransferOTPRequestParams, ValidateScheduledTransferOTPHandler, ValidateScheduledTransferOTPResponse, ValidateScheduledTransferOTPParser> {
    
    public static let SERVICE_NAME = "validaPeriodicasSepaOtpLa"
    ...
    public override var serviceName: String {
        return ValidateScheduledTransferOTPRequest.SERVICE_NAME
    }
...
public struct ValidateScheduledTransferOTPRequestParams {
