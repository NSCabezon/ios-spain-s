import Foundation
public class ConfirmAccountTransferRequest: BSANSoapRequest <ConfirmAccountTransferRequestParams, ConfirmAccountTransferHandler, BSANSoapResponse, ConfirmAccountTransferParser> {
    
    public static let serviceName = "confirmarTraspasoSEPA_LA"
    
    public override var serviceName: String {
        return ConfirmAccountTransferRequest.serviceName
    }
    ...
    private var trusteer: String {
        getTrusteerData(params.trusteerInfo, withUrl: "/mobile/traspasos")
    }
