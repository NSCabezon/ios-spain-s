...
public class ConfirmDuplicateBillRequest: BSANSoapRequest<ConfirmDuplicateBillRequestParams, BSANSoapEmptyParser.Handler, BSANSoapEmptyResponse, BSANSoapEmptyParser> {
    
    static public var serviceName = "confirmaSolicitudDuplicadoLa"
    
    public override var serviceName: String {
        return ConfirmDuplicateBillRequest.serviceName
    }
