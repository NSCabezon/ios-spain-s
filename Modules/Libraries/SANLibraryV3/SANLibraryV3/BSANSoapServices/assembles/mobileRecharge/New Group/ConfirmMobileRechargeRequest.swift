public class ConfirmMobileRechargeRequest: BSANSoapRequest<ConfirmMobileRechargeRequestParams, BSANSoapEmptyParser.Handler, BSANSoapEmptyResponse, BSANSoapEmptyParser>  {
    public static let SERVICE_NAME = "confirmaRecargaMovilLa"
    
    public override var serviceName: String {
        return ConfirmMobileRechargeRequest.SERVICE_NAME
    }
