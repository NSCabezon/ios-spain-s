//
//  SetFinancialHealthCategoriesInputDTO.swift
//  CoreDomain
//
...
struct GetFinancialHealthCategoryInputDTO: Encodable {
    let dateFrom: String?
    let dateTo: String?
    var scale: String?
    var category: String?
    ...
    init?(_ representable: GetFinancialHealthCategoryInputRepresentable) {
...
struct GetFinancialHealthCategoryProductInputDTO: Encodable {
    var productType: String?
    let id: String?
    
    init(_ representable: GetFinancialHealthCategoryProductInputRepresentable) {
