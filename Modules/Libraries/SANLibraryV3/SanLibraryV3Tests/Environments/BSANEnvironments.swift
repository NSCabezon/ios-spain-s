...
public struct BSANEnvironments {
    ...
    // Recover password -> Principal screen
    ...
    // Recover password -> Lateral drawer
    ...
    static let environmentPro: BSANEnvironmentDTO =
        BSANEnvironmentDTO(
            ...
            urlGetNewPassword: getNewPasswordUrlPro,
            urlForgotPassword: forgetPasswordUrlPro,
    ...
    static let environmentOcu = BSANEnvironmentDTO(
        ...
        urlGetNewPassword: getNewPasswordUrlOcu,
        urlForgotPassword: forgetPasswordUrlOcu,
    ...
    static let environmentPre = BSANEnvironmentDTO(
        ...
        urlGetNewPassword: getNewPasswordUrlPre,
        urlForgotPassword: forgetPasswordUrlPre,
    ...
    static let environmentDev = BSANEnvironmentDTO(
        ...
        urlGetNewPassword: getNewPasswordUrlDev,
        urlForgotPassword: forgetPasswordUrlDev,
        ...
        click2CallURL: click2CallUrlPRE,
        branchLocatorGlobile: branchLocatorGlobile,
        insurancesPass2Url: insurancesPass2EndpointUrlDev,
        pass2oauthClientId: pass2RestOauthClientIdPre,
        pass2oauthClientSecret: pass2RestOauthClientSecretPre,
        ecommerceUrl: ecommerceMicroUrlPre,
        fintechUrl: fintechUrlPre
    ...
    static let environmentCiber = BSANEnvironmentDTO(
        ...
        urlGetNewPassword: getNewPasswordUrlCiber,
        urlForgotPassword: forgetPasswordUrlCiber,
